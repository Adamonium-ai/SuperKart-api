...
Product_Id_char = st.selectbox("Product Category (from ID)", ["FD", "DR", "NC"])
Store_Age_Years = st.number_input("Store Age (Years)", min_value=0, max_value=50, value=15, step=1)
